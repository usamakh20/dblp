...
CREATE TABLE `coauthors` (
  ...
  KEY `fk_coauthors_2_idx` (`author_id_2`),
  CONSTRAINT `fk_coauthors_1` FOREIGN KEY (`author_id_1`) REFERENCES `author` (`id`),
  CONSTRAINT `fk_coauthors_2` FOREIGN KEY (`author_id_2`) REFERENCES `author` (`id`)
